 ...
 *  @param   priority - 扭把我抉把我找快找 (抉找 0 忱抉 1)
 ******************************************************************************
 */
...
RV_STATIC_INLINE void NVIC_SetPriority(IRQn_Type IRQn, uint8_t priority) {
    ...
    NVIC->IPRIOR[(uint32_t)(IRQn)] = priority << 6U;
}
 ...
 *  @attention 完快技 扶我忪快 扶抉技快把 扭把我抉把我找快找忘 - 找快技 抉扶 志抑扮快. 0 - 志抑扼扮我抄 扭把我抉把我找快找.
 *  @param IRQn_Type IRQn - 扭把快把抑志忘扶我快
 *  @retval 圾抉戒志把忘投忘快找 扶抉技快把 扭把我抉把我找快找忘, 志 忱忘扶扶抉技 扼抖批折忘快 抉找 0 忱抉 1.
 ******************************************************************************
 */

RV_STATIC_INLINE uint8_t NVIC_GetPriority(IRQn_Type IRQn) {
    return NVIC->IPRIOR[(uint32_t) (IRQn)] << 6U;
}
